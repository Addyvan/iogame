  ...
  setSnapshot: function (data1) {
    ...
    for (var i2 = 0; i2 < len2; i2++) {
        ...
        for (var i4 = 0; i4 < len4; i4++) {
            var data5 = data4[i4];
            writer.writeUInt16BE(data5.x + 5622);
            writer.writeUInt8(data5.hp);
            writer.writeUInt8(data5.type + 229);
            writer.writeUInt16BE(data5.angle + 30904);
            writer.writeUInt16BE(data5.y + 33667);
        }
    }
    writer.writeUInt32BE(data1.timestamp + 2126937084);
    writer.writeUInt32BE(data1.tick + 3695880678);
